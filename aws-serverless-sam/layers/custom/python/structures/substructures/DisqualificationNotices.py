...
class DisqualificationNotices(Structure):
    product_family_name = PRODUCT_FAMILY_DISQUALIFICATION_NOTICES
    supported_product_codes = ['PNDL148H', 'PNDL148I']
        ...
        for i, _line in enumerate(lines):
            ...
            try:
                if is_type_01(line):
                    ...
                    row['End_Date'] = self.get_formatted_date(row['End_Date'])
    ...
    def email_subject(self, row) -> str:
        return 'Disqualification notice of your demerit points'

    def history_title(self, row: dict) -> str:
        return 'Your disqualification notice of your demerit points is attached for your review.'
