...
class MarineLicOpRem(Structure):
    product_family_name = PRODUCT_FAMILY_MARINE_LICENCE_REMINDER
    supported_product_codes = ['LicOpRem']
    ...
    def email_subject(self, row) -> str:
        return 'Your marine licence renewal is overdue'

    def history_title(self, row) -> str:
        return 'Your marine licence expired on {}. Final overdue notice.'.format(row['ExpDate1'])
