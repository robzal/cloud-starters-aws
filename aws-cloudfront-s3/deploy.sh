...
deploy_stack $1 $AWS_PROFILE ${APP_CODE}-${ENVIRONMENT}-solution cfn/cloudfront-s3.yaml cfn/cloudfront-s3.params ${CLOUDFORMATION_BUCKET} ${APP_CODE} ${CHANGESET_OPTION}  
